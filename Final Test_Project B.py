...
dataset = pd.read_csv('C:/Users/Yangyongji/Desktop/python数据处理/数据分析训练营-结营考试/数据分析训练营-结营考试/ProjectB/产品表.csv', header = None,encoding='unicode_escape') 
# shape为(7501,20)
print(dataset.shape)
#print(dataset[:10])
...
#hot_encoded.to_csv('C:/Users/Yangyongji/Desktop/python数据处理/数据分析训练营-结营考试/数据分析训练营-结营考试/ProjectB/产品表.csv)
